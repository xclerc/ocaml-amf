...
(* OASIS_START *)
(* DO NOT EDIT (digest: 06fcc152cb36633f54b6b89592fd2d49) *)
(*
...
let setup_t =
  {
            ...
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args =
                   ["-use-ocamlfind"; "-docflags '-thread' -package core"];
                 run_path = "."
              })
       ];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("oUnit.advanced", None);
                           FindlibPackage ("oUnit.threads", None);
                           FindlibPackage ("bisect_ppx-ocamlbuild", None);
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for AMF";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_digest = Some "\234H\220O\187\005\197w'^\177\022\2156\n\012";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
